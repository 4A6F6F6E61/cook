...
Color primaryColor(Brightness brightness) => brightness == .dark ? Colors.red : Colors.redAccent;
...
ThemeData buildTheme(Brightness brightness) {
  ...
  return baseTheme.copyWith(textTheme: GoogleFonts.lexendDecaTextTheme(baseTheme.textTheme));
}

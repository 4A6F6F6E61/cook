...
mixin _$Ingredient {
 ...
 String get id; String? get userId; String get name; String? get category; double get calories; double get protein; double get carbs; double get fat;
...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,id,userId,name,category,calories,protein,carbs,fat);

@override
String toString() {
  return 'Ingredient(id: $id, userId: $userId, name: $name, category: $category, calories: $calories, protein: $protein, carbs: $carbs, fat: $fat)';
}
...
@useResult
$Res call({
 String id, String? userId, String name, String? category, double calories, double protein, double carbs, double fat
});
...
/// Create a copy of Ingredient
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? id = null,Object? userId = freezed,Object? name = null,Object? category = freezed,Object? calories = null,Object? protein = null,Object? carbs = null,Object? fat = null,}) {
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( String id,  String? userId,  String name,  String? category,  double calories,  double protein,  double carbs,  double fat)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _Ingredient() when $default != null:
return $default(_that.id,_that.userId,_that.name,_that.category,_that.calories,_that.protein,_that.carbs,_that.fat);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( String id,  String? userId,  String name,  String? category,  double calories,  double protein,  double carbs,  double fat)  $default,) {final _that = this;
switch (_that) {
case _Ingredient():
return $default(_that.id,_that.userId,_that.name,_that.category,_that.calories,_that.protein,_that.carbs,_that.fat);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( String id,  String? userId,  String name,  String? category,  double calories,  double protein,  double carbs,  double fat)?  $default,) {final _that = this;
switch (_that) {
case _Ingredient() when $default != null:
return $default(_that.id,_that.userId,_that.name,_that.category,_that.calories,_that.protein,_that.carbs,_that.fat);case _:
  return null;
...
class _Ingredient implements Ingredient {
  const _Ingredient({required this.id, this.userId, required this.name, this.category, this.calories = 0.0, this.protein = 0.0, this.carbs = 0.0, this.fat = 0.0});
...
/// Create a copy of Ingredient
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? id = null,Object? userId = freezed,Object? name = null,Object? category = freezed,Object? calories = null,Object? protein = null,Object? carbs = null,Object? fat = null,}) {
